...
function dibujarFormulario(){
   var html = dibujarCabecera();
	
	//usamos enctype="multipart/form-data" para que el formulario pueda enviar archivos
...
function responderSubida(archivo_subido){
   ...
   if(archivo_subido){
      html += '<p> <strong> El archivo se ha sido subido correctamente. <strong> </p>';
   }else{
